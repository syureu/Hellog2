...
urlpatterns = [
    ...
    path('user_nfc_login/', views.user_nfc_login, name='user_nfc_login'),
    ...
    path('select_exercise/<str:exercise_name>/<int:exercise_id>/',
         views.select_exercise, name="select_exercise"),
]